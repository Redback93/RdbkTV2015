...
class Project 
{
	...
	public function __construct($bgImage, $logoImage, $name, $involvement, $client, $description, $date, $source)
	{
...
return array (
	"projects" => array(
		...
		"osuceleb" => new Project("osuceleb-bg.jpg", "osuceleb-logo.png", "OsuCelebrity", "Application and Web Development", "Tillerino",
			...
			"February 2015", "https://github.com/OsuCelebrity/OsuCelebrity"),
		...
		"August 2015", "https://github.com/RedbackThomson/MarketMonitor"),
		...
		"September 2014", "https://github.com/RedbackThomson/LoLShadow"),
		...
		"August 2014", "https://github.com/RedbackThomson/LoLAlerter"),
		...
		"June 2014", "https://github.com/RedbackThomson/OsuTrack"),
		...
		"December 2013", "https://github.com/RedbackThomson/OsuRequestBot"),
