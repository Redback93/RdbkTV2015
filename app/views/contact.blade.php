...
<div class="full-container">
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2 text-center contact-header">
				<h1>Wanna chat? Have e-coffee? Propose a new project?</h1>
			</div>
		</div>
	</div>
</div>
<section class="dark-bg contact-section">
	<div class="container">
		<div class="row">
			<div class="col-md-4 col-md-offset-1">
				<p class="contact-slogan">I'm always available for a good chat about any projects, designs or ideas!</p>
			</div>
			<div class="col-md-6">
